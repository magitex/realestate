...
<head>
  ...
  <!-- Google Font -->
    <?= link_tag('assets/bower_components/jquery-ui/jquery-ui-1.10.3.custom.min.css'); ?>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('Dashboard'); ?>" class="logo">
      ...
      <span class="logo-lg"><b>Construction </b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  Role: <?php echo $this->session->userdata('user_role'); ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <?php echo anchor('Login/userLogout', 'Sign Out', ['class' => 'btn btn-danger btn-flat']); ?>
